    ...
    return (
        <div className="position-relative">
            <div className="authentication-wrapper authentication-basic container-p-y p-4 p-sm-0">
                <div className="authentication-inner py-6" style={{ maxWidth: "450px", margin: "auto" }}>
                    ...
                    <div className="card p-md-7 p-1">
                        ...
                        <div className="card-body mt-1">
                           ...
                           <div className='text-center mb-5'>
                             <button
                                className={`btn ${formstate === "login" ? "btn-primary" : "btn-outline-primary"}`}
                                onClick={() => setFormState("login")}
                            >
                                Sign In
                            </button>
                            <button
                                className={`btn ms-2 ${formstate === "register" ? "btn-primary" : "btn-outline-primary"}`}
                            ...
                            <form id="formAuthentication" className="mb-5 mt-5" action="index.html" method="GET">
                                {formstate === "register" ? <div className="form-floating form-floating-outline mb-5">
                                    <input
                                        type="text"
                                ...
                                {formstate === "login" ? <div className="mb-5">
                                    <button className="btn btn-primary d-grid w-100" type="submit">Sign In</button>
                                </div> :<></>}
                                {formstate === "register" ? <div className="mb-5">
                            ...
                            {/* <p className="text-center">
                                ...
                                <a href="#" onClick={() => setFormState("register")} className="d-flex align-items-center justify-content-center">
